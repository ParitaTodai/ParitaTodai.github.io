...
let TableService = class TableService {
    ...
    getTableData() {
        return this._httpClient.get(this.get_url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((resData) => resData.results), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => { return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])('Check again'); }));
    }
};
 ...
 */
let ScrollableComponent = class ScrollableComponent {
    constructor(_tableService, _location) {
    ...
    getData() {
        let response = this._tableService.getTableData();
        response.subscribe(resData => this.dataSource.data = resData);
    }
    backCLicked() {
        this._location.back();
    }
};
ScrollableComponent.ctorParameters = () => [
